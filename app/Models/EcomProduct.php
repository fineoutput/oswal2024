...
class EcomProduct extends Model
{
    ...
    protected $fillable = [
        'category_id ', 'product_category_id ', 'name', 'long_desc','vendor_desc',
         'name_hi', 'long_desc_hi', 'url', 'url', 'hsn_code', 'video', 'img1', 'img2', 'img3', 'img4', 'img_app1', 'img_app2', 'img_app3', 'img_app4', 'is_active', 'is_cat_delete', 'cur_date', 'ip', 'added_by', 'is_hot', 'is_featured','vendor_offer', 'product_view','free_product_id','update_id'
    ];
