                    ...
                    <div class="col-12">
                        ...
                        <div class="card m-b-20">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('offerslidersecound.store') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-sm-12 mb-3">
                                            ...
                                            <div class="form-floating">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ $slider ? $slider->offer_name : old('offer_name') }}"
                                                    name="offer_name" placeholder="Enter offer_name" required>

                                                <label for="offer_name">Offer Name &nbsp;<span
