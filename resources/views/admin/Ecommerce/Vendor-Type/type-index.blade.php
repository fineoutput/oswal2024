                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <a class="btn btn-info" href="{{ route('vendor.type.create', $routeParameters) }}" role="button">Add Type</a>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="btn-group" id="btns{{ $key }}">
                                                                ...
                                                                @if ($value->is_active == 0)
                                                                    ...
                                                                    <a href="{{ route('vendor.type.update-status', $routeParameters) }}" data-toggle="tooltip" data-placement="top" title="Active"><i class="fas fa-check success-icon"></i></a>
                                                            ...
                                                            <div style="display:none" id="cnfbox{{ $key }}">
                                                                ...
                                                                <a href="{{ route('vendor.type.destroy', $routeParameters) }}" class="btn btn-danger">Yes</a>
