                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2"> 
                                        ...
                                        <a class="btn btn-info cticket" href="{{ route('majorproduct.create') }}" role="button" style="margin-left: 20px;"> Add Products</a>
                                        ...
                                        <table id="userTable" class="table  table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $product->majorcategory->name }}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="btn-group" id="btns<?php echo $key ?>">
                                                            ...
                                                            <a href="{{route('majorproduct.update-status',['active',base64_encode($product->id)])}}" data-toggle="tooltip" data-placement="top" title="Active"><i class="fas fa-check success-icon"></i></a>

                                                            @else

                                                            <a href="{{route('majorproduct.update-status',['inactive',base64_encode($product->id)])}}" data-toggle="tooltip" data-placement="top" title="Inactive"><i class="fas fa-times danger-icon"></i></a>

                                                            @endif

                                                            <a href="{{route('majorproduct.create',base64_encode($product->id))}}" data-toggle="tooltip" data-placement="top" title="edit"><i class="fas fa-edit"></i></a>
                                                        ...
                                                        <div style="display:none" id="cnfbox<?php echo $key ?>">
                                                            ...
                                                            <a href="{{route('majorproduct.destroy', base64_encode($product->id))}}" class="btn btn-danger">Yes</a>
