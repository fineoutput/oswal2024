                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="btn-group" id="btns<?php echo $key ?>">
                                                            ...
                                                            <a href="{{route('webslidersecound.update-status',['active',base64_encode($slider->id)])}}" data-toggle="tooltip" data-placement="top" title="Active"><i class="fas fa-check success-icon"></i></a>

                                                            @else

                                                            <a href="{{route('webslidersecound.update-status',['inactive',base64_encode($slider->id)])}}" data-toggle="tooltip" data-placement="top" title="Inactive"><i class="fas fa-times danger-icon"></i></a>

                                                            @endif

                                                            <a href="{{route('webslidersecound.create',[base64_encode($slider->id)])}}" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i></a>
                                                        ...
                                                        <div style="display:none" id="cnfbox<?php echo $key ?>">
                                                            ...
                                                            <a href="{{route('webslidersecound.destroy', base64_encode($slider->id))}}" class="btn btn-danger">Yes</a>
