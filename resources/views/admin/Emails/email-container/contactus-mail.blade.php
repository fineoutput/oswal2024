...
<head>
    ...
    <style id="media-query" type="text/css">
        @media (max-width: 670px) {
            ...
            img.fullwidth,
            img.fullwidthOnMobile img.allimage {
                max-width: 100% !important;
            }
            ...
            <tr style="vertical-align: top;" valign="top">
                <td style="word-break: break-word; vertical-align: top;" valign="top">
                                ...
                                <div class="col num12"
                                    ...
                                    <div class="container-liquid">
                                        <div style="background-color:#FFFFFF;width:100% !important;">
                                            <!--[if (!mso)&(!IE)]><!-->
                                            <div
                                                style="border-top:0px solid transparent; border-left:8px solid #F1F3F3; border-bottom:0px solid transparent; border-right:8px solid #F1F3F3;">
                                                <!--<![endif]-->
                                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Arial, sans-serif"><![endif]-->
                                                <div
                                                    style="color:#CFCFCF;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:120%;">
                                                    <div
                                                        style="font-size: 12px; line-height: 14px; font-family: Arial,Helvetica Neue, Helvetica, sans-serif; color: #CFCFCF;">
                                                        <p
                                                            ...
                                                            <img align="center" alt="Image" border="0"
                                                                ...
                                                                src="{{asset('admin/assets/emailer/oswalall.png')}}"></img>
                                                        </p>
                                                    </div>
                                                </div>
                            ...
                            <div
                                ...
                                <div class="col num12"
                                    ...
                                    <div style="background-color:#FFFFFF;width:100% !important;">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div
                                            style="border-top:0px solid transparent; border-left:8px solid #F1F3F3; border-bottom:0px solid transparent; border-right:8px solid #F1F3F3; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
                                            <!--<![endif]-->
                                            <div align="center" class="img-container center autowidth fullwidth"
                                                ...
                                                <div style="font-size:1px;line-height:10px"> </div><img align="center"
                                                    ...
                                                    src="{{asset('admin/assets/emailer/divider.png')}}"
                                    ...
                                    <div style="background-color:#FFFFFF;width:100% !important;">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    style="font-size: 12px; line-height: 18px; font-family: Arial,Helvetica Neue, Helvetica, sans-serif; color: #555555;">
                                                    <p
                                                        style="font-size: 14px; line-height: 25px; text-align: left; margin: 0;">
                                                        <span style="font-size: 17px; mso-ansi-font-size: 18px;">{!! $data['msg'] !!}</span></p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            <!--[if (!mso)&(!IE)]><!-->
                            ...
                            <div
                                ...
                                <div class="col num12"
                                    ...
                                    <div style="width:100% !important;">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div
                                            style="border-top:0px solid transparent; border-left:8px solid #F1F3F3; border-bottom:0px solid transparent; border-right:8px solid #F1F3F3; padding-top:0px; padding-bottom:45px; padding-right: 0px; padding-left: 0px;">
                                            <!--<![endif]-->
                  ...
                  <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 50px;" align="left"><![endif]-->
                    ...
                    <div style="background-color:transparent;">
                        <div class="block-grid"
                            style="Margin: 0 auto; min-width: 320px; max-width: 650px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: #edf457;">
                            <div
                                style="border-collapse: collapse;display: table;width: 100%;background-color:#edf457;">
                                ...
                                <div class="col num12"
                                    ...
                                    <div style="width:100% !important;">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div
                                            style="border-top:0px solid transparent; border-left:8px solid #F1F3F3; border-bottom:0px solid transparent; border-right:8px solid #F1F3F3; padding-top:30px; padding-bottom:25px; padding-right: 0px; padding-left: 0px;">
                                            <!--<![endif]-->
                                            <div align="center" class="img-container center fixedwidth"
                                                ...
                                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img
                                                    ...
                                                    src="{{asset('admin/assets/emailer/oswalall.png')}}"
                                            ...
                                            <div
                                                style="color:#353535;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:0px;padding-left:10px;">
                                                <div
                                                    style="font-size: 12px; line-height: 14px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; color: #353535;">
                                                    <p
                                                        style="font-size: 14px; line-height: 16px; text-align: center; margin: 0;">
                                                                ...
                                                                <tbody>
                                                                    <tr align="center"
                                                                        ...
                                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px;"
                                                                            valign="top"><a
                                                                                href="https://www.facebook.com/OswalProduct/"
                                                                                target="_blank"><img alt="Facebook"
                                                                                    height="32"
                                                                                    src="{{ asset('admin/assets/emailer/facebook@2x.png') }}"
                                                                                    style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;"
                                                                                    title="Facebook"
                                                                                    width="32" /></a></td>
                                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px;"
                                                                            valign="top"><a
                                                                                href="https://twitter.com/oswallgroup"
                                                                                target="_blank"><img alt="Twitter"
                                                                                    height="32"
                                                                                    src="{{asset('admin/assets/emailer/twitter@2x.png') }}"
                                                                                    style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;"
                                                                                    title="Twitter"
                                                                                    width="32" /></a></td>
                                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px;"
                                                                            valign="top"><a
                                                                                href="https://www.instagram.com/oswalproducts/"
                                                                                target="_blank"><img alt="Instagram"
                                                                                    height="32"
                                                                                    src="{{asset('admin/assets/emailer/instagram@2x.png') }}"
                                                                                    style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;"
                                                                                    title="Instagram"
                                                                                    width="32" /></a></td>
                                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px;"
                                                                            valign="top"><a
                                                                                href="https://www.linkedin.com/in/oswal-products-375979114"
                                                                                target="_blank"><img alt="LinkedIn"
                                                                                    height="32"
                                                                                    src="{{asset('admin/assets/emailer/linkedin@2x.png')}}"
                                                                                    style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;"
                                                                                    title="LinkedIn"
                                                                                    width="32" /></a></td>
                                                                    </tr>
                            ...
                            <div
                                ...
                                <div class="col num12"
                                    ...
                                    <div style="background-color:#FFFFFF;width:100% !important;">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div
                                            style="border-top:0px solid transparent; border-left:8px solid #F1F3F3; border-bottom:0px solid transparent; border-right:8px solid #F1F3F3; padding-top:30px; padding-bottom:30px; padding-right: 50px; padding-left: 50px;">
                                            <!--<![endif]-->
                                            <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Arial, sans-serif"><![endif]-->
                                            <div
                                                ...
                                                <div
                                                    style="font-size: 12px; line-height: 14px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; color: #555555;">
                                                    <p
                                                        style="font-size: 14px; line-height: 16px; text-align: left; margin: 0;">
                                                        Contact Us- +91-91161 71956 / <strong><a
                                                                href="https://www.oswalsoap.com/" rel="noopener"
                                                                style="text-decoration: underline; color: #66BECD;"
                                                                target="_blank">customercare@oswalsoap.com</a></strong>
                                                    </p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
