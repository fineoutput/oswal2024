        ...
        <div class="col-lg-4 col-4">
            <div class="row" style="display: flex; justify-content: start;">
                <div class="col-lg-8 header_expo" style="width: 100%;">
                    <div style="margin-top: 2rem;" class="d-flex flex-wrap justify-content-lg-start justify-content-end align-items-center header_item_icon">
                        <form action="{{ route('search') }}" method="get">

                            <input name="query" class="input-inset me-3 d-none d-lg-block" type="text" placeholder="Search" />
                        ...
                        @php $count = 0; if(Auth::check()){ $identifierColumn = 'user_id'; $identifierValue = Auth::user()->id; $count = App\Models\Wishlist::where('user_id', Auth::user()->id)->count(); }else{ $identifierColumn =
                        'persistent_id'; $identifierValue = sendPersistentId(request()); } $cartCount = App\Models\Cart::where($identifierColumn, $identifierValue)->count(); @endphp
