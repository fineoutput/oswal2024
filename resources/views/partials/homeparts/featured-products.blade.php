                                ...
                                <div class="upper_txt_qty">
                                    ...
                                    <div class="quant" id="quantity-section{{ $product->id }}" @if ($cart == null) style="display: none;" @endif>
                                        ...
                                        <div class="input-group" style="display: flex; align-items: center;">
                                            ...
                                            <input class="qv-quantity form-control quantity-input" id="quantity-input{{ $product->id }}" type="number" name="quantity" min="1" value="{{ $cart->quantity ?? 0 }}" size="1" max="5"
...
<!-- //////Featured products web section end -->

<!-- //////Featured products mobile section -->
