...
<section class="product-sect py-5 d-none d-lg-block">
    ...
    <div class="container">
        ...
        <div class="row">
    @php
        // Limit to 8 products and chunk into groups of 4
        $productsChunked = $products->take(8)->chunk(4);
    @endphp
                        ...
                        <div class="product_part_upper">
                            ...
                            <a href="{{ route('product-detail', ['slug' => $product->url]) }}">
                                ...
                                <div class="card_upper_img" style="height: 250px; width: 250px;">
                                    ...
                                    <img src="{{ asset($product->img1) }}" alt="Secondary Image" class="secound-image" style="width: 100%; height: 100%;" />
