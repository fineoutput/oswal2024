<div class="details-product-content">
    ...
    <div class="details-product-price">
        <p class="details-last-price">Selling Price: <span>₹50</span></p>
        <p class="details-new-price">Market Price: <span>₹40</span></p>
    </div>
    ...
    <div class="details-purchase-info">
        <div class="set_insider">
            ...
            <input style="border: 1px solid #d8172863 !important;" id="form1" min="0"
                name="quantity" value="1" type="number"
                class="form-control form-control-sm carts_puts" />
        ...
        <button type="button" class="details-btn">Add to Cart <i
