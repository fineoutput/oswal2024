    ...
    <div class="container">
      <div class="row justify-content-md-center">
        <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
          <h2 class="mb-4 display-5 text-center">Build your career with us</h2>
          ...
          <div class="card border border-dark rounded shadow-sm overflow-hidden">
            <div class="card-body p-0">
              <div class="row gy-3 gy-md-4 gy-lg-0">
                <div class="col-12 col-lg-6 bsb-overlay background-position-center background-size-cover" style="--bsb-overlay-opacity: 0.7; background-image: url('images/hot_bg.jpg');">
                  <div class="row align-items-lg-center justify-content-center h-100">
                    <div class="col-11 col-xl-10">
                      <div class="contact-info-wrapper py-4 py-xl-5">
                        ...
                        <p class="lead fs-4 text-light opacity-75 mb-4 mb-xxl-5">Get in touch and let us know how we can help. Fill out the form and we'll be in touch as soon as possible.</p>
                        <div class="d-flex mb-4 mb-xxl-5">
                          ...
                          <div>
                            ...
                            <address class="mb-0 text-light opacity-75">Uttam Chand Desraj 10/OB/35, Oswal Tower, Ring Road Project, Near Reliance Petrol Pump, Lakeshra, Agra Road, Jaipur-303012</address>
                          </div>
                        </div>
                          ...
                          <div class="col-12 col-xxl-6">
                            <div class="d-flex mb-4 mb-xxl-0">
                              ...
                              <div>
                                ...
                                <p class="mb-0">
                                  <a class="link-light link-opacity-75 link-opacity-100-hover text-decoration-none" href="tel:+15057922430">+91-91161 71956</a>
                                </p>
                              </div>
                            </div>
                          </div>
                          <div class="col-12 col-xxl-6">
                            <div class="d-flex mb-0">
                              ...
                              <div>
                                ...
                                <p class="mb-0">
                                  <a class="link-light link-opacity-75 link-opacity-100-hover text-decoration-none" href="mailto:info@oswalsoap1956.com">info@oswalsoap1956.com</a>
                                </p>
                              </div>
                            </div>
                          </div>
